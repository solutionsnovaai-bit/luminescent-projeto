    ...
    <section className="bg-lilac-mist pb-24 md:pb-32">
      <div className="wrap grid items-center gap-12 md:grid-cols-2 md:gap-16">
        <div className="reveal order-2 md:order-1">
          <span className="label mb-5 inline-flex items-center gap-3 text-orchid">
            <i className="h-px w-6 bg-orchid/50" />
            como fica na prática
          </span>
          <h2 className="h-display mb-6 text-[clamp(28px,4.6vw,44px)] text-plum">
            Enquanto você dorme,<br />alguém continua respondendo por você.
          </h2>
          <p className="text-[15.5px] leading-relaxed text-plum-ink/65">
        ...
        <div className="reveal order-1 flex justify-center md:order-2">
          <div className="w-full max-w-[300px] overflow-hidden rounded-[2rem] border-8 border-plum-ink bg-[#e5ddd5] shadow-[0_30px_70px_-20px_rgba(26,5,48,.45)]">
